  ...
  const events = [
    {
      ...
      title: 'Earnings Call & Board Meeting',
      subtitle: 'Reliance Industries Ltd',
      date: 'May 2, 2026 5:00 PM IST',
    },
    {
      icon: (
      ...
      subtitle: 'Keynote & Strategic Roadmap',
      date: 'June 10, 2026',
    },
    {
      icon: (
      ...
      title: 'Dividend Payout Date',
      subtitle: '₹10.00 per equity share',
      date: 'May 16, 2026',
    },
  ];
