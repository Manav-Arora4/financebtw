...
export const CandlestickChart: React.FC = () => {
  ...
  // Helper to map price to Y coordinate in svg viewbox 0 0 780 200
  const minP = 2940.0;
  const maxP = 3030.0;
  ...
  const svgWidth = 780;
  const stepX = (svgWidth - 75) / totalCandles;
      ...
      <div className="chart-body-with-toolbar">
        ...
        <div className="chart-drawing-toolbar">
          <button className="tool-btn active" title="Crosshair">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="2" x2="12" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/></svg>
          </button>
          <button className="tool-btn" title="Trendline">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="4" y1="20" x2="20" y2="4"/><circle cx="4" cy="20" r="2"/><circle cx="20" cy="4" r="2"/></svg>
          </button>
          ...
          <button className="tool-btn" title="Text Note">
            <span style={{ fontWeight: 800, fontSize: 11 }}>T</span>
          </button>
          ...
          <button className="tool-btn" title="Measure">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21.3 15.3l-6.6-6.6a2 2 0 0 0-2.8 0L3.3 17.3a2 2 0 0 0 0 2.8l.6.6a2 2 0 0 0 2.8 0l8.6-8.6"/></svg>
          </button>
        ...
        <div className="chart-canvas-viewport">
          ...
          <div className="svg-candlestick-wrapper">
            <svg viewBox="0 0 780 200" className="candlestick-svg" preserveAspectRatio="none">
              {/* Horizontal Price Grid Lines */}
              <line x1="0" y1="30" x2="780" y2="30" stroke="#161f30" strokeDasharray="3,3" />
              <line x1="0" y1="70" x2="780" y2="70" stroke="#161f30" strokeDasharray="3,3" />
              <line x1="0" y1="110" x2="780" y2="110" stroke="#161f30" strokeDasharray="3,3" />
              <line x1="0" y1="150" x2="780" y2="150" stroke="#161f30" strokeDasharray="3,3" />

              {/* Right Y Axis Price Labels */}
              <text x="720" y="34" fill="#64748b" fontSize="9" fontFamily="Inter">3,020.00</text>
              <text x="720" y="74" fill="#64748b" fontSize="9" fontFamily="Inter">3,000.00</text>
              <text x="720" y="114" fill="#64748b" fontSize="9" fontFamily="Inter">2,980.00</text>
              <text x="720" y="154" fill="#64748b" fontSize="9" fontFamily="Inter">2,960.00</text>
              <text x="720" y="180" fill="#64748b" fontSize="9" fontFamily="Inter">2,940.00</text>

              {/* Volume Bars at bottom */}
              {candles.map((c, i) => {
                const posX = 15 + i * stepX;
                const vHeight = Math.min(c.vol * 0.4, 35);
                return (
                  <rect
                    key={`vol-${i}`}
                    x={posX - 3}
              ...
              <line x1="0" y1="75" x2="780" y2="75" stroke="#22c55e" strokeDasharray="4,4" strokeWidth={1.5} />
              <rect x="705" y="65" width="70" height="18" fill="#22c55e" rx={3} />
              <text x="712" y="78" fill="#000" fontSize="9" fontWeight="800" fontFamily="Inter">
                2,985.50
              </text>
            </svg>
